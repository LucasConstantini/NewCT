...
<div>
    <div class="tabela">
        <display:table name="lista" id="item" pagesize="5" requestURI="" defaultsort="1" sort="list">
            ...
            <display:column value="<img src='img/editar.png'alt='Editar'>" href="TransporteShowForm.mtw" title="Editar" paramId="id" paramProperty="id" style="width:15%;"/>
            <display:column value="<img src='img/lixeira.png'alt='Excluir'>" href="TransporteDelete.mtw"  title="Excluir" paramId="id" paramProperty="id" class="deleteLink" style="width:15%;"/>
        </display:table>
    </div>
</div>
<!--------------------------------------------------------------------------------->        
